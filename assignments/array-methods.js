...
console.log(`Full name is ${ currentValue.first_name + currentValue.last_name}`);
})
...
console.log(largeShirts);
 const newrunners= largeShirts.map(function(currentValue){
...
// ============================================================
// Problem 1: Create a list of email ids of all the participants
// ============================================================

let allEmails = [];
runners.forEach(function(currentValue){
console.log(`${currentValue.first_name} has an emailid ${ currentValue.email }`);
})
console.log(allEmails);

// ============================================================
// Problem 2:Create an array of company names of the participants.
// ============================================================
let companyNames = [];
companyNames= runners.map(function(currentValue){
    return currentValue.company_name;
})
console.log(companyNames); 

// ============================================================
// Problem 3: Create an array of participants with first name beginning with letters [A-G]
// ============================================================
let firstNamesFromAToG = [];
firstNamesFromAToG = runners.filter(function(currentValue){
    return currentValue.first_name.charAt(0).match("[A-G]");
})
console.log(firstNamesFromAToG);
let arrNamesFromAToG = [];
arrNamesFromAToG=firstNamesFromAToG .map(function(currentValue){
    return currentValue.first_name;
})
console.log(arrNamesFromAToG);